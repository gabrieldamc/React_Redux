...
export default class Formulario extends React.Component {
    ...
    alteraCarga = function (carga_horaria) {
        this.setState({ carga_horaria })
    }
                    ...
                    <form>
                        <div className="form-group row">
                            ...
                            <div className="col-sm-5 col-6">
                                <input type="number"
                                    className="form-control" id="codigo" value={this.state.codigo} onChange={(e) => this.alteraCodigo(e.target.value)} />
                            </div>
                        </div>
                        <div className="form-group row">
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-5 col-6">
                                <input type="number"
                                    className="form-control" id="cargaHoraria" value={this.state.carga_horaria} onChange={(e) => this.alteraCarga(e.target.value)} />
                            </div>
                        </div>
                        <div className="form-group row">
                            <label htmlFor="preco"
