...
export const adicionaContato = (codigo, descricao, cargaHoraria, preco, categoria, textoBotao) => {
    axios.post(URL, { codigo, descricao, cargaHoraria, preco, categoria, textoBotao })
    return {
        type: 'LIMPAR_FORM'
    }
}
